...
// Finance-Approver
         ...
         Route::get('collectors-receipt-approver','ApproverController@collectors_receipt_approver')->name('collectors_receipt_approver');
         Route::get('user-approve','ApproverController@approve')->name('approve');
         ...
         Route::get('checkbook-receipt-approver','ApproverController@checkbook_receipt_approver')->name('checkbook_receipt_approver');
...
Route::get('/collectors-receipt-reviewer', [ReviewerController::class, 'collectorReceiptReview'])->name('collector.receipt.reviewer');
