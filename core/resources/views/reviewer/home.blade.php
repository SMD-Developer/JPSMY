...
body{
  ...
  height: 260px;
  border-radius: 50%;
  display: block; /* ensures Safari renders it properly */
  background:
    radial-gradient(
      circle closest-side,
      transparent 100%,
        ...
        <div class="container-fl">
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="info-box" style="background: #E2FFED; cursor: pointer;"
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <a href="{{route('collectors_receipt_review')}}" style="color:#212529;">
