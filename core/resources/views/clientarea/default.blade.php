        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="filterSearchForm"  class="filterform">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-md-3">
                        <label for="city" class="col-md-3 col-form-label">@lang('app.applicant'):</label>
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-md-3">
                            <label for="ownershipNumber" class="col-md-3 col-form-label">@lang('app.no_ownership'):</label>
                        </div>    
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="ownershipNumber" placeholder=" @lang('app.no_ownership') ">
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-9">
                            <div class=" gap-2">
                                <div class="captcha-image" style="width: 50%; height: 50px; background: #e9ecef; text-align: center; display: flex; align-items: center; justify-content: center;">
                                    <span>A P Q B</span>
                                </div>
                                <div class="d-flex" style="align-items: baseline;">
                                <input type="text" class="form-control mt-1" id="captcha" placeholder=" @lang('app.captcha') ">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <button type="submit" class="btn btn-warning"><i class="fa fa-search"></i> @lang('app.search')</button>&nbsp;&nbsp;
