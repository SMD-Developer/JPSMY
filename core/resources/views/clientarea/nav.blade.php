...
.sidebar {
    max-height: 100vh !important; /* Restrict to viewport height */
    overflow-y: auto !important; /* Enable vertical scrolling */
    overflow-x: hidden !important; /* Avoid horizontal scroll */
}

/* Ensure submenu does not overflow */
.nav-treeview {
    max-height: 75vh !important; /* Adjust based on design */
    overflow-y: auto !important; /* Enable scrolling within the submenu */
}
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
   <div style="display: flex; justify-content: center; align-items: center;">
    ...
    <section class="sidebar" style="overflow-y: auto; max-height: 100vh;margin: 100px 0px !important;">
        <!-- Sidebar user panel -->
        <!--@if(auth('user')->check())-->
        ...
        <h4 class="mt-5">{{ trans('Sistem e-CP (Caruman Parit)') }}</h4>
        <nav class="mt-2 mb-5">
            <ul class="nav nav-pills nav-sidebar flex-column sidebar-menu" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->is('clientarea/new-application') ? 'menu-open' : '' }}">
                 ...
                 <li class="nav-item {{ request()->is('clientarea/new-application') ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link  {{ request()->is('clientarea/new-application') ? 'active' : '' }}">
                        <i class="fa fa-folder-open"></i>
                        <span>{{ trans('app.claim_contribution') }}</span>
                        <i class="fa fa-angle-right right"></i>
                        <!-- Dropdown arrow -->
