                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4 col-6 position-relative">
                                            <div class="form-group inlin">
                                                ...
                                                <i class="bi bi-eye-slash toggle-password position-absolute end-0 top-50 translate-middle-y me-3 text-muted cursor-pointer" data-target="password" style="cursor:pointer; margin-top: -8px;"></i>
                                            </div>
                                            <span class="text-danger px-4" id="password-error"></span>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4 col-6 position-relative">
                                            <div class="form-group inlin">
                                                ...
                                                <i class="bi bi-eye-slash toggle-password position-absolute end-0 top-50 translate-middle-y me-3 text-muted cursor-pointer" data-target="setPassword" style="cursor:pointer;padding-bottom: 20px;"></i>
                                            </div>
                                            <span class="text-danger" id="password-match-error" style="padding: 0px 20px;"></span>
                                        </div>
                                        <div class="col-md-5">
                                            <span class="star d-inline"><b>*</b></span>
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.success) {
                ...
                Swal.fire({
                    title: "@lang('app.success')",
                    text: "Registration successful! Please check your email for the OTP verification code.",
                    icon: "success",
