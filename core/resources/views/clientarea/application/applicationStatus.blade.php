                                ...
                                <tbody>
                                    @forelse($applications as $key => $application)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($application->status == 'approved')
                                                     @if ($application->payment && $application->payment->payment_status === 'completed')
                                                        <!--<span-->
                                                        <!--    class="badge bg-success py-1 px-3 rounded-pill " style="font-size: 12px;">{{ trans('app.payment_complete') }}</span>-->
                                                    ...
                                                    @elseif($application->payment && $application->payment->payment_status === 'pending_authorization')
                                                        <!--<span-->
                                                        <!--    class="badge bg-secondary" style="font-size: 12px;">{{ trans('app.payment_pending') }}</span>-->
                                                    ...
                                                    @elseif ($application->payment_status === 'in review' && $application->client && $application->client->accountType == 3)
                                                        <!--<span-->
                                                        <!--    class="badge bg-info">{{ trans('app.waiting_for_Review') }}</span>-->
