                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <label for="statusFilter" class="me-2">
                                       {{ trans('app.filter_payments') }} : </label>
                                    <select id="statusFilter" class="form-select form-select-sm"
                                        ...
                                        <option value="completed"
                                            {{ ($statusFilter ?? 'all') == 'completed' ? 'selected' : '' }}>
                                            <!--Complete-->
                                             @lang('app.completed')
                                        </option>
                                        <option value="incomplete"
                                            {{ ($statusFilter ?? 'all') == 'incomplete' ? 'selected' : '' }}>
                                            <!--Incomplete-->
                                             @lang('app.incomplete')
                                        </option>
                                        <option value="in_review"
                                            {{ ($statusFilter ?? 'all') == 'in_review' ? 'selected' : '' }}>
                                            <!--In review-->
                                             @lang('app.in_review')
                                        </option>
                                    </select>
