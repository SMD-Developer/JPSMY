...
class HomeController extends Controller {
    ...
    //         $applications = Application::with(['client', 'logs', 'payment'])
    ...
    //         return view('clientarea.application.applicationStatus', compact('applications'));
    //     }
...
// Government-agency start
    ...
    //                 'redirect' => url()->previous() // Or specify a redirect URL
    //             ]);
    //         } catch (\Exception $e) {
    //             return response()->json([
    //                 'success' => false,
