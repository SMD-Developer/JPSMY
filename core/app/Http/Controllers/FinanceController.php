...
class financeController extends Controller {
    ...
    public function approved_statement(){
        return view('finance.approved_statement');
    }
    ...
    public function dailyPaymentReceiptReport(Request $request)
{
    ...
    \Log::info('Applications created_at timestamps: ', 
        $applications->pluck('created_at')->toArray()
    );
    ...
    if ($startDate && $endDate && $applications->isEmpty()) {
        ...
        \Log::warning('No applications found in date range', [
        ...
        $dateRange = DB::table('applications')
            ...
            ->first();
        \Log::info('Actual date range in database: ', (array) $dateRange);
    }
